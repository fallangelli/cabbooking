...
$sql_fectch_city = mysqli_query("select *, date_format(add_date,'%b %d, %Y') as rdate from tbl_user where id='" . $_REQUEST['did'] . "' and usertype='driver'") or die(mysqli_error());
...
<table border="0" align="center" width="100%" cellpadding="2" cellspacing="0" class="tableSearch">
    <tr bgcolor="#f1f1f1">
        <td valign="top" class="tdLabel" colspan="2" align="center"><b>Driver Details</b></td>
    </tr>
    <tr>
