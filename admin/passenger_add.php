...
if (isset($_REQUEST['submit'])) {
    ...
    if ($found == 0) {
        ...
        set_session_msg("PASSENGER has been added successfully");
        ?>
        ...
        set_session_msg("PASSENGER already exist.");
    }
}
...
if (isset($_REQUEST['update'])) {
    ...
    if ($found == 0) {
        ...
        set_session_msg("PASSENGER has been updated successfully");
        ?>
        <script language="javascript">location.href = 'manage_passenger.php'</script>
        <?php
        exit;
...
<?php include("top.inc.php"); ?>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td id="pageHead">
                <div id="txtPageHead"><?php if ($_REQUEST['set_flag'] == 'update') echo "Edit PASSENGER";
                    else echo "Add PASSENGER"; ?></div>
            </td>
        </tr>
    </table>
    <div align="right" style="padding-right:5px;"><a href="<?= $_SERVER[HTTP_REFERER] ?>">Back to PASSENGER
            Listings </a></div>
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td id="content" align="center"><strong class="msg"><?= display_sess_msg() ?></strong>
                <form method="post" action="" name="form2" id="form2" enctype="multipart/form-data"
                    ...
                    <table border="0" width="70%" align="center" cellpadding="2" cellspacing="0" class="tableSearch">
                        <tr align="center">
                            <th colspan="2"><?php if ($_REQUEST['set_flag'] == 'update') echo "Edit PASSENGER";
                                else echo "Add PASSENGER"; ?></th>
                        </tr>
                        <tr>
                            <td height="10"></td>
                        </tr>
                        ...
                        <tr>
                            <td class="lightGrayBg" valign="bottom">Passenger Image</td>
                            <td class="lightGrayBg"><input name="image" type="file"> Upload Passenger Image
                                <?php if ($image) { ?>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <td class="lightGrayBg"><input name="usertype" size="48" type="text"
                                                           value="<?= passenger ?>"/></td>
                        </tr>
                        <tr>
                            <td colspan="2">&nbsp;</td>
