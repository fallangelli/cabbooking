...
if (is_post_back()) {
    ...
    @mail($res_user, $welcome_subject, $welcome_message, $HEADERS);
    //@mail('sb@localhost.com', $welcome_subject, $welcome_message, $HEADERS);$_SESSION['error_msg'] = "Message Sent Sucessfully!";}
    ?>
