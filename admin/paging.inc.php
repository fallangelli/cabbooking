...
//echo("<br>$j");
    ...
    <table width="50%" border="0" cellspacing="2" cellpadding="0" align="right">
        <tr>
            ...
            <td class="subcat" width="52%" align="center" height="20"><?php
                ...
                for ($i = $j; $i < $k; $i++) {
                    ...
                    if (($pagesize * ($i)) != $start) {
                        ...
                        <a href="<?= $PHP_SELF ?><?= $qry_str ?>&start=<?= $pagesize * ($i) ?>"
                           style="text-decoration:none;" class="subcat">
                            <?= $i + 1 ?>
                        </a>
                        <?php
                    } else {
            ...
            <td width="10%" align="center"><? $mod = $reccnt % $pagesize;
                if ($mod == 0) {
                    $mod = $pagesize;
                } ?>
